<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageWorstStudent.aspx.cs" Inherits="ITMO.ASP.Exam.PageWorstStudent" MasterPageFile="~/Site.master"%>

<asp:Content ID="MainContent" 
    ContentPlaceHolderID="ContentPlaceHolder1" runat="server"> 
    <div>
        <h2>5 худших студентов</h2>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:всеволод-key.StudentControlDB %>" 
                SelectCommand="SELECT TOP (5) [FirstName], [SecondName], [Group], [FinalScore] FROM [StudentsTable] ORDER BY [FinalScore] ASC"></asp:SqlDataSource>
